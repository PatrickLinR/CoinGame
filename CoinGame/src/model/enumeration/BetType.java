...
public enum BetType
{
      COIN1
      {
         ...
         {
            // TODO implementation
        	 if(spinnerResult.getCoin1().getFace().equals(player.getResult().getCoin1().getFace())) {
      ...
      COIN2
      {
        ...
        {
           // TODO implementation
       	 if(spinnerResult.getCoin2().getFace().equals(player.getResult().getCoin2().getFace())) {
       		 player.setPoints(player.getPoints() + player.getBet());
       	 } else {
       		 player.setPoints(player.getPoints() - player.getBet());
       	 }
      ...
      BOTH
      {
		...
		public void applyWinLoss(Player player, CoinPair spinnerResult)
        {
           // TODO implementation
       	 if(spinnerResult.getCoin1().getFace().equals(player.getResult().getCoin1().getFace()) 
       			 && spinnerResult.getCoin2().getFace().equals(player.getResult().getCoin2().getFace())) {
